import {
  useTheme
} from "./chunk-XJOLUPP2.js";
import {
  Transition_default,
  useForkRef_default
} from "./chunk-AHA4OPQF.js";
import {
  require_react_dom
...
} from "./chunk-4OWRD4GE.js";
import {
  _extends,
  _objectWithoutPropertiesLoose
} from "./chunk-NHTWQ2S7.js";
import {
  require_jsx_runtime
...
var TextareaAutosize = React71.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const renders = React71.useRef(0);
  const [state, setState] = React71.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React71.useCallback(() => {
...
var Grow = React75.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children,
  ...
  const autoTimeout = React75.useRef();
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DMRYGIMT.js.map
